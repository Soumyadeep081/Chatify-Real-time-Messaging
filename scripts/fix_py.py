...
def run_fix_py():
    try:
        with open('components/ChatRoom.tsx', 'r', encoding='utf-8') as f:
            text = f.read()
        ...
        with open('components/ChatRoom.tsx', 'w', encoding='utf-8') as f:
            f.write(new_text)
...
def run_fix8_py():
    try:
        with codecs.open('components/ChatRoom.tsx', 'r', 'utf-8') as f:
            lines = f.readlines()
        ...
        if len(lines) > 888:
            ...
            with codecs.open('components/ChatRoom.tsx', 'w', 'utf-8') as f:
                f.writelines(lines)
    except Exception as e:
